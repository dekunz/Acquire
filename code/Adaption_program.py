...
def game(var1,var2):  
    ...
    player1 = Player_adapt(6000,"player1",var1)
    player2 = Player_adapt(6000,"player2",var2)
    player3 = Player_adapt(6000,"player3",var1)
...
#function that plays m (=1000) games
...
#function that makes 1 variable converge towards its optimum
def converge(var,arr1,arr2):
    ...
    while(beta == 0 and k<=2):
        ...
        #1000 games are played with the first two variables
        ...
        while(difference>diff and tries1<=maxtries):
            #if the difference between the last two tries was small, halve the interval
            if difference<=doublediff:
                alpha/=2.
            a = (better*alpha*arr2)
            var = var +a
            #play 1000 games with two variables
            ...
            #if the new variable was better, continue in this direction; otherwise switch
            if (newtot>=lasttot):
                better*=1.
            else:
                better*=-1.
            ...
            lasttot=newtot
            tries1+=1
            #if the variable does not converge after maxtries (=15), abort the iteration
            if tries1==maxtries:
                converge1=False
            if difference<=diff:
                if lasttot >newtot:
...
#call converge for each variable
t10=time.time()
...
print("Variables",var)
print()
print("Convergence 1:",c1,"Iterations:",t1)
print()
print("Convergence 2:",c2,"Iterations:",t2)
print()
print("Convergence 3:",c3,"Iterations:",t3)
print()
print("Convergence 4:",c4,"Iterations:",t4)
print()
print("Convergence 5:",c5,"Iterations:",t5)
print()
print("Convergence 6:",c6,"Iterations:",t6)
print()
print("Convergence 7:",c7,"Iterations:",t7)
print()
print("Convergence 8:",c8,"Iterations:",t8)
print()
print("Convergence 9:",c9,"Iterations:",t9)
print()
print("Adjusted player:",p19)
print()
print("Normal Player:",p29)
print()
print("Adjusted player:",p39)
print()
print("Normal Player:",p49)
print()
